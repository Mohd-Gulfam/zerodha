        ...
        <div className='container p-5'>
            <div className='row p-5'> 
                ...
                <div className='col-6 p-5'>
                    <img src='media/ecosystem.png' style={{width:"100%"}} alt='eco'/>
                    <div>
                        <a href='a' className='mx-5 ' style={{textDecoration:"none"}}>Explore our product <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
