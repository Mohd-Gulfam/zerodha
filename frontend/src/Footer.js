  ...
  return (
    ...
    <div className="container mt-5 border-top">
      <div className="row mt-5">
        ...
        <div className="col  ">
          <p>Company</p>
          <a href="#"className="text-muted mt-10" style={{textDecoration:"none"}} >About</a>
          <br></br>
          <a href="#"className="text-muted mt-10" style={{textDecoration:"none"}}>product</a>
          <br></br>
          <a href="#"  className="text-muted mt-10"style={{textDecoration:"none"}}>pricing</a>
          <br></br>
          <a href="#"className="text-muted  mt-10" style={{textDecoration:"none"}}>referral programme</a>
          <br></br>
          <a href="#"className="text-muted  mt-10" style={{textDecoration:"none"}}>careers</a>
          <br></br>
          <a href="#"className="text-muted  mt-10" style={{textDecoration:"none"}}>Zerodha.tech</a>
          <br></br>
          <a href="#"className="text-muted  mt-10" style={{textDecoration:"none"}}>Press & media</a>
          <br></br>
          <a href="#"className="text-muted  mt-10" style={{textDecoration:"none"}}>Zerodha cares(CSR)</a>
        </div>
        <div className="col">
          <p>Suport</p>
          ...
          <br></br>
          <a href="#"className="text-muted" style={{textDecoration:"none"}}>List of chardes</a>
          <br></br>
          <a href="#"className="text-muted" style={{textDecoration:"none"}}>Downloads and resource</a>
          <br></br>
        </div>
        <div className="col">
          <p>Account</p>
          ...
          <br></br>
          <a href="#"className="text-muted" style={{textDecoration:"none"}}>60 day chllenge </a>
          <br></br>
        </div>
      </div>
